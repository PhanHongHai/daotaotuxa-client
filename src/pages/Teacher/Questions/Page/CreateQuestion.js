...
const mapStateToProps = state => ({
	createQuestionStatus: state.questionPageTeacher.createQuestionStatus,
	getSubjectsForQuestionStatus: state.questionPageTeacher.getSubjectsForQuestion,
	subjects: state.questionPageTeacher.subjects,
});

const mapDispatchToProps = {
	createQuestionReq: QuestionAction.createQuestionTeacherRequest,
