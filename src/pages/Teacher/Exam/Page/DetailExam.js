...
const mapStateToProps = state => ({
	getDetailExamStatus: state.examPageTeacher.getDetailExamStatus,
	updateExamStatus: state.examPageTeacher.updateExamStatus,
	removeExamStatus: state.examPageTeacher.removeExamStatus,
	authPasswordStatus: state.examPageTeacher.authPasswordStatus,
	detailExam: state.examPageTeacher.detailExam,
});

const mapDispatchToProps = {
	authPasswordReq: ExamAction.authPasswordExamTeacherRequest,
	getDetailExamReq: ExamAction.getDetailExamTeacherRequest,
	updateExamReq: ExamAction.updateExamTeacherRequest,
	removeExamReq: ExamAction.removeDetailExamTeacherRequest,
};
