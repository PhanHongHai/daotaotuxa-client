...
const mapStateToProps = state => ({
	createExamStatus: state.examPageTeacher.createExamStatus,
	getQuestionsStatus: state.examPageTeacher.getQuestionsForExamStatus,
	questions: state.examPageTeacher.questions,
});

const mapDispatchToProps = {
	createExamReq: ExamAction.createExamTeacherRequest,
	getQuestionsReq: ExamAction.getQuestionsForExamTeacherRequest,
};
