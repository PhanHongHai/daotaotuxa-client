...
const mapStateToProps = state => ({
	updateQuestionStatus: state.questionPage.updateQuestionStatus,
	removeQuestionStatus: state.questionPage.removeQuestionStatus,
	getDetailQuestionStatus: state.questionPage.getDetailQuestionStatus,
	getSubjectsForQuestionStatus: state.questionPage.getSubjectsForQuestionStatus,
	detailQuestion: state.questionPage.detailQuestion,
	subjects: state.questionPage.subjects,
});

const mapDispatchToProps = {
	getDetailQuestionReq: QuestionAction.getDetailQuestionRequest,
	updateQuestionReq: QuestionAction.updateQuestionRequest,
	getSubjectsForQuestionReq: QuestionAction.getSubjectsForQuestionRequest,
	removeQuestionReq: QuestionAction.removeDetailQuestionRequest,
};
