			...
			<div className="phh-page-header">
				<Row>
					<Col xs={24} sm={24} md={24}>
						<BreadCrumb breadcrumb={breadcrumb} pageCurrentText="Chi tiết môn học" />
					</Col>
				</Row>
			</div>
			<div className="pd-1">
...
const mapStateToProps = state => ({
	getDetailSubjectStatus: state.subjectPage.getDetailSubjectStatus,
	updateSubjectStatus: state.subjectPage.updateSubjectStatus,
	deleteSubjectStatus: state.subjectPage.deleteSubjectStatus,
	getDocumentsStatus: state.subjectPage.getDocumentStatus,
	deleteFileDocStatus: state.subjectPage.deleteFileDocStatus,
	getDetailDocumentStatus: state.subjectPage.getDetailDocumentStatus,
	createDocumentStatus: state.subjectPage.createDocumentStatus,
	updateDocumentStatus: state.subjectPage.updateDocumentStatus,
	deleteDocumentStatus: state.subjectPage.deleteDocumentStatus,
	detailSubject: state.subjectPage.detailSubject,
	documents: state.subjectPage.documents,
	detailDocument: state.subjectPage.detailDocument,
});

const mapDispatchToProps = {
	getDetailSubjectReq: SubjectAction.getDetailSubjectRequest,
	getDetailDocumentReq: SubjectAction.getDetailDocumentRequest,
	getDocumetsReq: SubjectAction.getDocumentsRequest,
	createDocumentReq: SubjectAction.createDocumentRequest,
	updateDocumentReq: SubjectAction.updateDocumentRequest,
	deleteDocumentReq: SubjectAction.deleteDocumentRequest,
	updateSubjectReq: SubjectAction.updateSubjectRequest,
	deleteSubjectReq: SubjectAction.deleteDetailSubjectRequest,
	removeFileDocReq: SubjectAction.removeFileDocRequest,
};
