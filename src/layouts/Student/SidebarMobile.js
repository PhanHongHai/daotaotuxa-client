...
function SidebarMobile(props) {
	const { collapsed, setCollapsed, onChangePage,  userData, handleLogout, loadingGet,setVisibleModalInfo } = props;
				...
				<div className="info">
					...
					<span className="info-user">
						<Dropdown
							...
							overlay={
								<Menu>
									<Menu.Item onClick={() => setVisibleModalInfo(true)}>
										<Icon type="user" />
										Quản lý tài khoản
									</Menu.Item>
...
SidebarMobile.propTypes = {
	...
	setVisibleModalInfo: PropTypes.func.isRequired,
